...
from yoloapi import yolo_init
from yoloapi import yolo_image
...
####################################
data=[]
def writeboundcsv(arr):
    csv_file_path = "C:/Users/aesnr123/Desktop/comparedata/bounding資料.csv"
    with open(csv_file_path, mode='w', newline='') as file:
        writer = csv.writer(file)
        writer.writerows(arr)
np.random.seed(100)
COLORS = np.random.randint(150, 255, size=(100, 3), dtype="uint8")
config_file="C:/Users/aesnr123/Desktop/yolo_image/yolo/yolov4.cfg"
data_file="C:/Users/aesnr123/Desktop/yolo_image/yolo/coco.data"
weight="C:/Users/aesnr123/Desktop/yolo_image/yolo/yolov4.weights"
network, class_names, class_colors=yolo_init(config_file, data_file,weight)
#########################################
...
for latter_name in file_list:
    ...
    if latter_name[0] == 'R' and int(latter_name[18 : 21]) - int(former_name[18 : 21]) == 1:
        ...
        yolo_latter_data, yolo_latter_ellipse_axis=yolo_image(latter_img,network, class_names, class_colors)
        data.append(["later",latter_name,latter_data,latter_ellipse_axis,yolo_latter_data, yolo_latter_ellipse_axis])
        ...
        if LAST_HR: rainfall_agent.record_rainfall_in_hour(compose_img_name)
        ...
        former_ellipse_axis = np.zeros((1, 2))
        yolo_former_data, former_ellipse_axis=yolo_image(former_img,network, class_names, class_colors)
        data.append(["former",former_name,former_data,former_ellipse_axis,yolo_former_data,former_ellipse_axis])
    else:
        # give a fake name
        former_name = '9'*25
    img_counter += 1
